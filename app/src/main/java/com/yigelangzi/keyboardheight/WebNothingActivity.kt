...
class WebNothingActivity : AppCompatActivity(), KeyboardHeightObserver {

    companion object {
        private const val TAG = "WebNothingActivity"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_web_nothing)
        ...
        webView = findViewById<WebView>(R.id.wv_main)
        ...
        webView.loadUrl("file:///android_asset/web_nothing.html")
    }
    ...
    override fun onKeyboardHeightChanged(height: Int, orientation: Int) {
        ...
        webView.loadUrl("javascript:changeInputBottom($heightDp)")
    }
}