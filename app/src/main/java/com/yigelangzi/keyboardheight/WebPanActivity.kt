...
class WebPanActivity : AppCompatActivity(), KeyboardHeightObserver {

    companion object {
        private const val TAG = "WebPanActivity"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_web_pan)
        ...
        webView.loadUrl("file:///android_asset/web_pan.html")
    }
